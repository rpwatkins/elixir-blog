...
BLOG_AUTHOR = "Rod Watkins"  # (translatable)
BLOG_TITLE = "Amateur Elixir"  # (translatable)
...
BLOG_EMAIL = "rodwatkins@outlook.com"
BLOG_DESCRIPTION = "Elixir for amateurs"  # (translatable)
